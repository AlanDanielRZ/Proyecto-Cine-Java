...
public class Facturas extends javax.swing.JFrame {
    ...
    private void txt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt1ActionPerformed
        ...
        if (txt1.getText().equals("")){
            JOptionPane.showMessageDialog(null,"** El ID Compra es Obligatorio **");
        }else
        {
    ...
    private void txt2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt2ActionPerformed
        ...
        if (txt2.getText().equals("")){
            JOptionPane.showMessageDialog(null,"** La Sucursal es Obligatorio **");
        }else
        {
    ...
    public void operacion(){
        ...
        while(
            tabla.next()){
            txt8.setText(tabla.getString(1));
            sw = 1;
            }
    ...
    public void modificar(){
        try{
            ...
            sql += "sucursal=\""+ txt2.getText()+"\",";
            sql += "fecha=now(),";
            sql += "cliente=\""+ txt4.getText()+"\",";
            sql += "descripcion=\""+ txt5.getText()+"\",";
            sql += "cantidad=\""+ txt6.getText()+"\",";
            sql += "precio=\""+ txt7.getText()+"\",";
            sql += "total=\""+ txt8.getText()+"\"";
            sql += "where idcompra=\""+ txt1.getText()+"\"";
            stmt = con.prepareStatement(sql);
    ...
    public void consultar(){
        sw=0;
        try{
            sql = "select*from facturas where idcompra= ";
            sql += "\""+ txt1.getText()+"\"";
            stmt = con.prepareStatement(sql);
            tabla = stmt.executeQuery();
            while(

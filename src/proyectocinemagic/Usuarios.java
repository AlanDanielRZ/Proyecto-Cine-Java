...
public class Usuarios extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txt5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
    ...
    private void txt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt1ActionPerformed
        if (txt1.getText().equals("")){
            JOptionPane.showMessageDialog(null,"** El ID usuario es Obligatorio **");
        }else
        {
...
if (txt3.getText().equals("")){
            JOptionPane.showMessageDialog(null,"** El password es Obligatorio **");
        }else
        {
    ...
    private void txt4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt4ActionPerformed
        if (txt4.getText().equals("")){
            JOptionPane.showMessageDialog(null,"** La fecha de Vencimiento es Obligatoria **");
        }else
        {
    ...
    private void txt5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt5ActionPerformed
        if (txt5.getText().equals("")){
            JOptionPane.showMessageDialog(null,"** El estatus actual es Obligatorio **");
        }else
        {
    ...
    public void modificar(){
        try{
            ...
            sql += "password=\""+ txt3.getText()+"\",";
            sql += "fecven=\""+ txt4.getText()+"\",";
